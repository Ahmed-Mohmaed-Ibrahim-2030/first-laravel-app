    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav me-auto">
                <x-nav-link href="{{ route('allBooks') }}" :active="request()->routeIs('dashboard')">
                    {{ __('Home') }}
                </x-nav-link>
                <x-nav-link href="{{ route('articles.index') }}" :active="request()->routeIs('dashboard')">
                    {{ __('All Phones') }}
                </x-nav-link>
                <x-nav-link href="{{ route('editUser') }}" :active="request()->routeIs('dashboard')">
                    {{ __('Edit Profile') }}
                </x-nav-link>
                <x-nav-link href="{{ route('articles.show',1) }}" :active="request()->routeIs('dashboard')">
                    {{ __('My Phones') }}
                </x-nav-link>
